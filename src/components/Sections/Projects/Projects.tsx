	...
	return (
		<SectionWrapper id="projects" className="pt-[6rem] mb-[6rem]">
			...
			<div className="grid grid-cols-1 lg:grid-cols-2">
				<ProjectCard>
					<ProjectCardHeader url="https://github.com/ausgore/glnn-org" image="../../../assets/images/glnn.png"> glnn.dev </ProjectCardHeader>
				...
				<ProjectCard>
					<ProjectCardHeader url="https://github.com/Kanahora/dishora" image="../../../assets/images/glnn.png"> Dishora </ProjectCardHeader>
				...
				<ProjectCard>
					<ProjectCardHeader url="https://github.com/Kanahora/Dains" image="../../../assets/images/glnn.png"> Dain's </ProjectCardHeader>
				...
				<ProjectCard>
					<ProjectCardHeader url="https://github.com/callmeglenn/ITApp-Project" image="../../../assets/images/glnn.png"> Bob </ProjectCardHeader>
				...
				<ProjectCard>
					<ProjectCardHeader url="https://github.com/callmeglenn/Pawfee-Beans" image="../../../assets/images/glnn.png"> Pawfee Beans </ProjectCardHeader>
