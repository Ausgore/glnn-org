	...
	return (
		<SectionWrapper id="projects" className="pt-[6rem] mb-[6rem]">
			...
			<div className="grid grid-cols-1 lg:grid-cols-2">
				<ProjectCard>
					<ProjectCardHeader url="https://github.com/ausgore/glnn-org" image="src/assets/images/glnn.png"> glnn.dev </ProjectCardHeader>
				...
				<ProjectCard>
					<ProjectCardHeader url="https://github.com/Kanahora/dishora" image="src/assets/images/dishora.png"> Dishora </ProjectCardHeader>
				...
				<ProjectCard>
					<ProjectCardHeader url="https://github.com/Kanahora/Dains" image="src/assets/images/dains.png"> Dain's </ProjectCardHeader>
				...
				<ProjectCard>
					<ProjectCardHeader url="https://github.com/callmeglenn/ITApp-Project" image="src/assets/images/bob.png"> Bob </ProjectCardHeader>
				...
				<ProjectCard>
					<ProjectCardHeader url="https://github.com/callmeglenn/Pawfee-Beans" image="src/assets/images/pawfee.png"> Pawfee Beans </ProjectCardHeader>
